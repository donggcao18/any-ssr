...
feature_layers = 4
gamma_global = 10000
router_weights_path = f'./output_models/router_weights_qwencoder7b_gamma{gamma_global}'
dataset_cache_path = f'./output_models/outputs_router_dataset_cache_qwencoder7b_gamma{gamma_global}'
